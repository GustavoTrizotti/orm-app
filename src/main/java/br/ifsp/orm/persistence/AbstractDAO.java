...
import br.ifsp.orm.contracts.Deletable;
import br.ifsp.orm.contracts.Registrable;
import br.ifsp.orm.contracts.Retrievable;
import br.ifsp.orm.contracts.Updatable;
...
public abstract class AbstractDAO<T, K> implements Registrable<T>, Retrievable<T, K>, Deletable<K>, Updatable<T> {
